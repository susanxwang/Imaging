...
//IsoData slightly fewer dots than Moments, MaxEntropy too low, Moments slightly too high, Otsu slightly less than Moments, RenyiEntropy too low, Shanbhag way too low, Triangle too many, but still not garbage, Yen too low, going with Otsu

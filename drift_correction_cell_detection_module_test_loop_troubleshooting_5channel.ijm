...
//		run("Merge Channels...", "c1=zproj_blur c2=zproj c3=C2-orig create");
		run("Merge Channels...", "c1=zproj_blur c2=zproj c3=C1-orig c4=C3-orig c5=C4-orig c6=C5-orig create");
		rename("tempmerge");
...
//		selectWindow("C3-registered time points");
		...
		rename("organelle");
		run("Merge Channels...", "c1=dna c2=organelle c3=blur c4=C6-tempmerge-registered c5=C4-tempmerge-registered c6=C5-tempmerge-registered create");
